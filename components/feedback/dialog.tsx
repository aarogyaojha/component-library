...
/**
 * A modal window component using Radix UI primitives.
 * Featuring the brand's premium aesthetic with soft backdrop and animations.
 */
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1 transition-all hover:bg-secondary/40 focus:outline-none focus:ring-2 focus:ring-primary/40">
