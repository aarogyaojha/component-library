...
import { ChevronRight, Code, Layout, Palette, Zap, Layers } from "lucide-react";
  ...
  return (
    <div className="space-y-12 animate-fade-in max-w-3xl">
      ...
      <section id="usage" className="space-y-8 pt-12 border-t border-ui-border/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="group border border-ui-border/50 rounded-2xl p-6 bg-card hover:border-primary/40 transition-all cursor-pointer">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Optimized for Next.js 15+ and Tailwind CSS v4 to ensure maximum speed and efficiency.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="props" className="space-y-6 pt-12 border-t border-ui-border/20">
        <h2 className="text-3xl font-bold tracking-tight">Ecosystem</h2>
        <p className="text-muted-foreground font-medium opacity-80">
          Built with the industry's best tools to ensure long-term maintainability and developer joy.
        </p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-4 bg-secondary/20 rounded-2xl border border-ui-border/30 text-center font-bold text-xs">Radix UI</div>
          <div className="p-4 bg-secondary/20 rounded-2xl border border-ui-border/30 text-center font-bold text-xs">Lucide Icons</div>
          <div className="p-4 bg-secondary/20 rounded-2xl border border-ui-border/30 text-center font-bold text-xs">Framer Motion</div>
          <div className="p-4 bg-secondary/20 rounded-2xl border border-ui-border/30 text-center font-bold text-xs">TypeScript</div>
        </div>
      </section>

      <section id="quick-start" className="mt-20 pt-12 border-t border-ui-border/20 space-y-6">
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          <Link href="/docs/installation">
            <Button className="rounded-2xl shadow-premium h-12 px-10 font-bold">
              Installation <ChevronRight className="w-4 h-4 ml-2" />
            </Button>
          </Link>
          <Link href="/docs/components">
            <Button variant="outline" className="rounded-2xl border-primary/20 h-12 px-10 font-bold group">
              Explore Components <Layers className="w-4 h-4 ml-2 group-hover:scale-110 transition-transform" />
            </Button>
          </Link>
        </div>
      </section>
